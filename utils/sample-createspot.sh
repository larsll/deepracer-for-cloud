...
aws ec2 run-instances \
    ...
    --user-data "#!/bin/bash
    su -c 'git clone https://github.com/larsll/deepracer-for-cloud.git &&  echo "$S3_LOCATION" > /home/ubuntu/deepracer-for-cloud/tmp/s3_training_location.txt && /home/ubuntu/deepracer-for-cloud/bin/prepare.sh' - ubuntu"
